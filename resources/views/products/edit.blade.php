    ...
    <div class="card-body">
        <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="product_name" id="product_name" class="form-input" value="{{ old('product_name', $product->product_name) }}" maxlength="255" required>
                @error('product_name')
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-input" rows="4" maxlength="1000" required>{{ old('description', $product->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    ...
                    <input type="number" name="unit_price" id="unit_price" class="form-input" value="{{ old('unit_price', $product->unit_price) }}" step="0.01" min="0" max="999999.99" style="padding-left: 2.5rem;" required>
                </div>
                @error('unit_price')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                <input type="number" name="lowstock_alert" id="lowstock_alert" class="form-input" value="{{ old('lowstock_alert', $product->lowstock_alert) }}" min="0" max="999999" required>
