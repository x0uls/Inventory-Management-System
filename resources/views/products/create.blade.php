...
@section('content')
<x-page-header title="Add Product" description="Create a new product" />
        ...
        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                >
                    ...
                    <div id="image-preview" style="display: none; position: relative;">
                        <img id="preview-img" src="" alt="Preview" style="max-height: 300px; max-width: 100%; object-fit: contain; margin: 0 auto; border-radius: var(--radius-sm); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    ...
                    <input type="number" name="unit_price" id="unit_price" class="form-input" value="{{ old('unit_price') }}" step="0.01" min="0" style="padding-left: 2rem;" required>
                </div>
                @error('unit_price')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
