    ...
    <div class="card-body">
        <form method="POST" action="{{ route('suppliers.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="supplier_name" id="supplier_name" class="form-input" value="{{ old('supplier_name') }}" required>
                @error('supplier_name')
            ...
            <div class="form-group">
                ...
                <input type="text" name="contact_person" id="contact_person" class="form-input" value="{{ old('contact_person') }}">
